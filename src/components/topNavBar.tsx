...
const NavBar: React.FC = () => {
  const [navExpend, setNavExpend] = useState(true);
        ...
        <div className="flex items-center space-x-4">
          <button onClick={handleToggle} className="text-white">
            {navExpend ? (
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" className="text-white" viewBox="0 0 16 16">
                <path fillRule="evenodd" d="M2 12.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5.5 0 0 1-.5-.5z" />
              </svg>
            )}
          </button>
          <Link href="/">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                <span className="text-white">Welcome, {user.uid}</span>
              ) : (
